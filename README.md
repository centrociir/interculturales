...
| 22/05/2025 | Reportes Automatizados en Quarto               | *(No disponible)*                                                                                             | *(En desarrollo)*                                                                                                                                                                                                                                                                                                                                                                                  | `quarto`, `tidyverse`              | [Guía Quarto](https://quarto.org/docs/get-started/hello/rstudio.html)                                                                               |
| 29/05/2025 | Análisis Geográficos: Aplicación al CENSO 2017 | *(No disponible)*                                                                                             | *(En desarrollo)*                                                                                                                                                                                                                                                                                                                                                                                  | `chilemapas`, `sf`, `tidyverse`    | [ChileMapas](https://github.com/juanmiguelsr/chilemapas)                                                                                            |
| 05/06/2025 | Análisis Cuantitativo de Texto en R            | *(No disponible)*                                                                                             | *(En desarrollo)*                                                                                                                                                                                                                                                                                                                                                                                  | `quanteda`, `tidyverse`            | [Text Mining with R](https://www.tidytextmining.com), [Paper 1](https://doi.org/10.1080/19312458.2017.1387238), [quanteda.io](https://quanteda.io/) |
| 12/06/2025 | Procesamiento de Datos en Python con Pandas    | *(No disponible)*                                                                                             | *(En desarrollo)*                                                                                                                                                                                                                                                                                                                                                                                  | `pandas`                           | [Pandas Guide](https://pandas.pydata.org/docs/)                                                                                                     |
| 19/06/2025 | Uso de APIs en Python                          | *(No disponible)*                                                                                             | *(En desarrollo)*                                                                                                                                                                                                                                                                                                                                                                                  | `requests`, `json`, `pandas`       | [OpenAI Docs](https://platform.openai.com/docs/)                                                                                                    |
| 26/06/2025 | Web Scraping                                   | *(No disponible)*                                                                                             | *(En desarrollo)*                                                                                                                                                                                                                                                                                                                                                                                  | `rvest`, `BeautifulSoup`, `scrapy` | [rvest](https://rvest.tidyverse.org), [Scrapy Docs](https://docs.scrapy.org/)                                                                       |
